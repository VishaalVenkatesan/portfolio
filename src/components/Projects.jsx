          ...
          <div className='flex justify-center items-center'>
            <div className='sm:grid sm:grid-cols-2 gap-4 sm:gap-[130px] flex flex-col'>
              {items.map(item => (
                ...
                >
                  <Image src={item.source} alt={item.title} layout="fill" objectFit="cover" />
                </motion.div>
              ))}
            </div>
          </div>
          {selectedItem && (
            <>
              ...
              <motion.div
                ...
                className={`fixed ${isMobile ? 'top-[10%] left-[7%] w-[70%] h-[60%]' : 'top-[30%] left-[27%] w-[500px] h-[400px]'} transform -translate-x-1/2 -translate-y-1/2 z-20 text-2xl text-black bg-gray-200 rounded-[30px] 
              ...
              >
                <div className='flex flex-col justify-between h-full pb-4'>
                  <div className=''>
                    ...
                    <motion.p className='font-lora'>{selectedItem.info}</motion.p>
                    <div className='flex justify-center pt-[20px]'>
                      <motion.p className='font-lora text-center bg-black text-white px-4 py-2 rounded-full'>{selectedItem.stack}</motion.p>
                    </div>
                  </div>
